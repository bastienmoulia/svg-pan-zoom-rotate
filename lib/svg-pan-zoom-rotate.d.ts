declare namespace SvgPanZoomRotate {
    interface Options {
    ...
    interface Instance {
        /**
         * Creates a new SvgPanZoomRotate instance with given element selector.
         *
        ...
        rotate(angle): Instance;

        rotateRelative(angle): Instance;
...
declare const svgPanZoomRotate:SvgPanZoomRotate.Instance;

declare module 'svg-pan-zoom-rotate' {
    export = svgPanZoomRotate;
}